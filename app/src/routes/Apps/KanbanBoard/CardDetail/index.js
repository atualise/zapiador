...
const CardDetail = ({ open, handleClose, selectedCard, onCardUpdate, selectedLaneId }) => {
  ...
  const updateCardDetails = useCallback(() => {
    return onCardUpdate({ ...selectedCard, title, description, dueDate, memberIds, activities }, selectedLaneId);
  }, [selectedCard, title, description, dueDate, memberIds, activities, selectedLaneId, onCardUpdate]);
  ...
  useEffect(() => {
    updateCardDetails();
  }, [dueDate, activities, members, title, description, updateCardDetails]);
